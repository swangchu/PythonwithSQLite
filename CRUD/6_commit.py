# So far our data in the database table was not persistant
# Meaning, the data is lost when the program is closed 
# But we have solution to this problem

# We will have to use COMMIT() method at the end of the program. This will have the data
# and will be available even after the program is closed
